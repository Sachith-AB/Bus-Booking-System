...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final List<Category> categories = [
      Category(id: '1', name: 'Coffee', iconPath: 'assets/icons/coffee.png'),
      Category(id: '2', name: 'Croissant', iconPath: 'assets/icons/croissant.png'),
      Category(id: '3', name: 'Crepe', iconPath: 'assets/icons/crepe.png'),
      Category(id: '4', name: 'Donut', iconPath: 'assets/icons/donut.png'),
      Category(id: '5', name: 'Bread', iconPath: 'assets/icons/bread.png'),
    ];
    ...
    final List<Map<String, dynamic>> banners = [
      {
        ...
        'imageUrl': 'assets/images/waffle_banner.jpg',
